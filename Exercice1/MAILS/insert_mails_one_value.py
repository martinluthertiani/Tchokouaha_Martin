# insert_Mails_one_value.py
# Martin Luther 2698.03.21 Démonstration de l'insertion d'une valeur dans un champ d'une table.
...
try:
    ...
    mysql_insert_string = "INSERT IGNORE INTO t_Mails (id_Mails, nom_Mail) VALUES (null, %(values_insert)s)"

    # Insertion de la valeur définie dans la variable "valeur_debile_mais_presque_aleatoire_a_inserer"
    # dans la table "t_Mails"
