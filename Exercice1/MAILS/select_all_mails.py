# select_all_mails.py
# Martin Luther 2020.03.26 le but est d'afficher tous les lignes de la table "t_mails" en MySql.
...
try:
    # Martin Luther 2020.03.26 Une instance "select_record" pour permettre l'utilisation des méthodes de la classe DbSelectOneTable
    ...
    mysql_select_string = "SELECT * FROM t_mails ORDER BY id_mails ASC"
    ...
    for row in records_select:
        print(row['id_mails'],row['nom_mail'])

    for row in records_select:
        output = "id: {id_mails}  mail: {nom_mail}"
