...
--
-- Client :  localhost
-- Généré le :  Jeu 02 Avril 2020 à 22:41
...
INSERT INTO `t_pers_mails` (`id_Pers_Mail`, `fk_Pers`, `fk_Mail`, `DateEnreg_Mail`) VALUES
(1, 5, 2, '2019-12-12'),
(2, 3, 1, '2020-02-25'),
(3, 1, 4, '2020-03-08');
...
--
ALTER TABLE `t_mails`
  MODIFY `id_Mails` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `t_pers_mails`
  MODIFY `id_Pers_Mail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `t_pers_teleph`
  MODIFY `id_Pers_Teleph` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
ALTER TABLE `t_pers_mails`
  ...
  ADD CONSTRAINT `t_pers_mails_ibfk_2` FOREIGN KEY (`fk_Mail`) REFERENCES `t_mails` (`id_Mails`);
