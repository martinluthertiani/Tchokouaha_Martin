# erreurs.py
# Martin Luther 2020.04.09 Définition des erreurs "personnalisées"
...
# Martin Luther 2020.04.12 Définition d'une classe qui permet, dès que "except" est détecté dans le bloc "try.. except MonErreur"
...
# Martin Luther 2020.04.16 En préparation pour galérer avec la gestion des erreurs
