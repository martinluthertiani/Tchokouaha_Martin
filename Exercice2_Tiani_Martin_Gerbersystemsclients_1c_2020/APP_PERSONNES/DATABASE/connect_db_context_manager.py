...
#
# Martin Luther 2020.04.05 Classe pour se connecter à la base de donnée.
#
...
from pymysql import cursors, err, connect
...
class MaBaseDeDonnee():
    ...
    def __init__(self):
        ...
        try:
            # Martin Luther 2019.04.05 ON SE CONNECTE A LA BASE DE DONNEE
            ...
            self.connexion_bd = connect(host=self.host,
                                        user=self.user,
        ...
        # Martin Luther 2020.03.11 Il y a un problème avec la BD (non connectée, nom erronné, etc)
        #
        except (Exception,
                ConnectionRefusedError,
                err.OperationalError,
                err.DatabaseError) as erreur:
    ...
    # Martin Luther 2020.04.10 Cette méthode est définie pour utiliser les "context manager"
