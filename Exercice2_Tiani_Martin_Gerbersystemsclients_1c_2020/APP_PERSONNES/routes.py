# routes.py
# Martin Lurher 2020.04.02 Pour faire des tests divers et variés.

from flask import render_template

from Exercice2_Tiani_Martin_Gerbersystemsclients_1c_2020.APP_PERSONNES import obj_mon_application
